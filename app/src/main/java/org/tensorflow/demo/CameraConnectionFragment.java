...
public class CameraConnectionFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        Button b = (Button) v.findViewById(R.id.buttonCommand);

        currentLang = getCurrentLang();

        if (currentLang.equals("vi")){
            b.setText("Chế độ phát hiện phương tiện giao thông");
        } else {
            b.setText("VIAS - Vehicles Detector");
        }

        b.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                speak("Thoát chế độ phát hiện phương tiện giao thông", "Close VIAS Vehicles Detector");
...
//        }
    ...
    private void voiceRecognize(int code){
    ...
    private void createCameraPreviewSession() {
        ...
        tfPreviewListener.initialize(
                getActivity(), getActivity().getAssets(), boundingBoxView, inferenceHandler, sensorOrientation, currentLang);
    ...
    private String getCurrentLang(){
        ...
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences(appPreference, MODE_PRIVATE);
