...
class TensorFlowClassifier implements Classifier {
  ...
  private final String[] class_labels =  {"máy bay", "xe đạp", "con chim", "tàu thủy", "chai nước", "xe buýt", "xe ôtô",
          "con mèo", "cái ghế", "con bò", "cái bàn", "con chó", "con ngựa", "xe máy", "người",
          "chậu cây", "con cừu", "ghế sofa", "tàu hỏa","ti vi"};
  ...
  public List<Recognition> recognizeImage(final Bitmap bitmap) {
    ...
    String[] labels = class_labels;

    final RectF boundingBox = new RectF(bounding_x, bounding_y, box_width, box_height);
    recognitions.add(new Recognition("Prediction ", labels[predicted_class], highest_prob, boundingBox));
    Trace.endSection();
    return recognitions;
  }
